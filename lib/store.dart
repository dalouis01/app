...
void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: <Widget>[Expanded(flex:3,child: buildFutureBuilder()),Expanded(flex:7,child: buildBuilder()) ],) 
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        onPressed: () {
                          ...
                          if (widget.id!=0){
                            ...
                            print(cartbool);
                            if (cartbool==true){
                              iconshop2=Icons.add_shopping_cart_outlined;
                         ...
                         print("add");
                            ...
                            info(context, "Fok ou konekte avan");
                          }
                      ...
                      IconButton(
                        ...
                        SizedBox(height: 8.0),
                        Text(
                          '\Htg${snapshot.data[index].price.toStringAsFixed(2)}',
                          style: TextStyle(
                            fontSize: 14.0,
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text('\Htg${product.price.toStringAsFixed(2)}', style: TextStyle(fontSize: 18)),
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
                // Ajoute nan panye
